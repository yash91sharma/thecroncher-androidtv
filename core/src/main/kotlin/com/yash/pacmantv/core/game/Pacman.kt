...
/**
 * Pac-Man. The only interesting part is the buffered turn: a direction pressed
 ...
 * unforgiving.
 */
class Pacman(maze: Maze) : Actor(maze) {
    ...
    fun reset(speed: Int = FULL_SPEED) {
        placeAtTileCentre(Maze.PACMAN_START_TILE, Direction.LEFT)
