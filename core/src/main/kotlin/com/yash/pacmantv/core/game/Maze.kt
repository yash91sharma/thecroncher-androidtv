...
enum class Tile {
    ...
    /** The gate to the ghost house: ghosts pass, Pac-Man does not. */
    DOOR,
...
class Maze private constructor(
    ...
    /** Where Pac-Man may go: everywhere except walls, the door and the house. */
    ...
    companion object {
        ...
        /** Pac-Man's dotless starting pocket, below the ghost house. */
        val PACMAN_START_TILE = TilePos(13, 23)
