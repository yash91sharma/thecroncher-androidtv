package com.yash.pacmantv.core.support
...
import com.yash.pacmantv.core.theme.Sprite
...
class RecordingGfx(
    ...
    sealed interface Call {
        ...
        data class Text(val text: String, val x: Int, val y: Int, val color: Int, val align: Align) : Call
    }
    ...
    override fun drawText(text: String, x: Int, y: Int, color: Int, align: Align) {
        calls += Call.Text(text, x, y, color, align)
    }
}
